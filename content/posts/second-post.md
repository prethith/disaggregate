...
[this](http://www.google.com) is a link.

This is some text with a sidenote{{< sidenote >}}
This appears in the right margin with a number.
{{< /sidenote >}} and the text continues.

You can also use left sidenotes{{< sidenote-left >}}
This appears in the left margin.
{{< /sidenote-left >}} which are aligned to the right.

Or margin notes without numbers{{< marginnote >}}
This has no number, just a ⊕ symbol to toggle on mobile.
{{< /marginnote >}} for supplementary info.
